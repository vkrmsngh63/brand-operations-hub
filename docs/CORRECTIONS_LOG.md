...
**Last updated in session:** session_2026-05-14_w2-main-deploy-session-12-p20-fingerprint-short-circuit-DEPLOYED (Claude Code; rebase on `workflow-2-competition-scraping`; ff-merge + deploy push on `main`)
