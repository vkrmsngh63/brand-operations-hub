...
**Last updated in session:** session_2026-05-19-b_w2-main-deploy-session-20-p19-overlay-dismiss-DEPLOYED (Claude Code, dual-branch — pre-deploy scoreboard on workflow-2, rebase + ff-merge + deploy on main, ping-pong sync after)
