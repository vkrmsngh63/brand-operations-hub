...
**Last updated in session:** session_2026-05-14_w2-main-deploy-session-11-region-screenshot-DEPLOYED-FULL-VERIFY (Claude Code; rebase on `workflow-2-competition-scraping`; ff-merge + verification on `main`)
