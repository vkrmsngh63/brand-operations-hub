...
|---|---|---|
| **P-53** | On-page "Export Table" button for the Category + Type pages — largely ABSORBED by P-55's grouped spreadsheets — **part of the (a.138) RECOMMENDED-NEXT W#2 residue** (with P-26/P-27; the director picks the order; honor `feedback_exports_include_all_table_data` if picked) | LOW (residue only) |
...
| **P-26 / P-27** | Below-fold scroll capture bugs + capture bugs #9 / #15 — **part of the (a.138) RECOMMENDED-NEXT W#2 residue** (with P-53; the director picks the order) | LOW |
