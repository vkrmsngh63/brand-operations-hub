...
- **Plan tier:** unknown to Claude — director needs to share at next session. Determines whether option (a) [pool sizing change] is feasible without a plan upgrade.
