...
**Status:** 🔴 OPEN (spec created 2026-06-02-i as the session's first artifact per Rule 31 — it did not exist before; captured 2026-06-02-d as ROADMAP entry P-59). W#2 Competition Scraping; the in-app `DetailedUserGuide.tsx`. NO schema change anticipated; NO new route anticipated (a content-only edit of one existing component).
