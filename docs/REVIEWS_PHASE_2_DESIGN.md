...
**Status:** 🟢 Design phase — initial interview FROZEN 2026-05-25 (this doc). Implementation begins next session with Workstream 2 Session 1 (Amazon per-platform extension extraction, bundling the §A.16 schema migration as the foundation step).
