    ...
    <div className="h-screen flex flex-col overflow-hidden bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 text-gray-100">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
        ...
        <div className="flex items-center gap-3">
          {/* Mode toggle placeholder — Manual / AI */}
          <div className="flex rounded-lg overflow-hidden border border-gray-700">
            <button className="px-4 py-1.5 text-sm bg-blue-600 text-white">Manual</button>
            <button className="px-4 py-1.5 text-sm bg-gray-800 text-gray-400 hover:text-white transition-colors">
              AI
            </button>
          </div>
        </div>
